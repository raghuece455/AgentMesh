...
AgentMesh is `v0.5.0` software. The security posture is **local-first and auth-ready**, designed for safe local development, evaluation, and single-team self-hosting — not yet enterprise-hardened.
