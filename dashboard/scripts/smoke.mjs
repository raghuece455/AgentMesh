...
async function main() {
  ...
  try {
    ...
    await clickButtonByText(client, 'Alerts')
    await waitForText(client, ['Firing now', 'Swarm too large', 'New destination reached', 'all swarms', 'all destinations'])
    await waitForText(client, ['has started 161 agents', 'reached for the first time'])
